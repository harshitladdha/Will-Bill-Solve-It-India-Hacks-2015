...
submissions_flat = pd.read_csv("test.csv")
users_flat = pd.read_csv("users_flat_test.csv")
problems_flat = pd.read_csv("problems_flat_test.csv")
...
result2.to_csv("result2_test.csv", index=False)