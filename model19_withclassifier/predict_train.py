...
#clf1 = RandomForestClassifier(n_estimators=200, criterion="entropy", max_features=0.5, random_state=1)
#clf1.fit(X_1,y_1)
...
#clf2 = RandomForestClassifier(n_estimators=200, criterion="entropy", max_features=0.5, random_state=1)
#clf2.fit(X_2, y_2)
...
clf3 = RandomForestClassifier(n_estimators=200, criterion="entropy", max_features=0.5, random_state=1)
clf3.fit(X,y)
