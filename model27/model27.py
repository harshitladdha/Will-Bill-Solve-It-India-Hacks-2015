...
model19 = np.genfromtxt("prob_y_pred_2_clf1_model19.csv", delimiter=',')
model19 = model19[:,1]
model19 = model19.reshape(model19.shape[0],1)
print model19.shape

model20 = np.genfromtxt("prob_y_pred_2_clf1_model20.csv", delimiter=',')
model20 = model20[:,1]
model20 = model20.reshape(model20.shape[0],1)
print model20.shape

model21 = np.genfromtxt("prob_y_pred_2_clf1_model21.csv", delimiter=',')
model21 = model21[:,1]
model21 = model21.reshape(model21.shape[0],1)
print model21.shape

model22 = np.genfromtxt("prob_y_pred_2_clf1_model22.csv", delimiter=',')
#model22 = model22[:,1]
model22 = model22.reshape(model22.shape[0],1)
print model22.shape

model23 = np.genfromtxt("prob_y_pred_2_clf1_model23.csv", delimiter=',')
#model23 = model23[:,1]
model23 = model22.reshape(model23.shape[0],1)
print model23.shape

X_new = np.append(X_new, model19, 1)
...
#max_depth_list = [15, 13, 11, 9 ,7]
#min_child_weight_list = [15, 20, 25]
#print depth, min_child, col
